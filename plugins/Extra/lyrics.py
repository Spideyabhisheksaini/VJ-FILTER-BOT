...
async def sng(bot, message):
    ...
    if vj.text:
        ...
        try:
            ...
            await vj.reply_text(f"I Can't Find A Song With `{song}`", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url = f"t.me/Tonystark_botz")]]))
    else:
